          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Image src={icon.injection} width={'30px'} height={'30px'}/>
                </div>
                <div>
                  <p style={{
                    margin : '0px',
                    padding : '0px',
                    fontSize : '16px'
                  }}>{(couponName === "")?"ชื่อคูปอง":couponName}</p>
                  <p style={{
                    margin : '0px',
                    padding : '0px',
                    fontSize : '12px'
                  }}>{checkRai(parseInt(raiConditionMin),parseInt(raiConditionMax))}</p>
                  <p style={{
                    margin : '0px',
                    padding : '0px',
                    fontSize : '12px',
                    color : '#747F8B'
                  }}>{expiredDate === ""?"หมดเขต XX เดือน XXXX":`หมดเขต ${expiredDate}`}</p>
                </div>
              </div>
            </div>
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  fontSize : '16px',
                  color : '#FB8705'
                }}>{count === ""?"XX":count}<span style={{
                  color : '#000'
                }}>/{count === ""?"XX":count} สิทธิ</span></p>
              </div>
              <div style={{
                width : '100%',
                height : '10px',
            ...
            <div style={{
              ...
              <p style={{
                fontSize : '16px',
                color : '#5F6872'
              }}>{`${startDate === "" ? `XX XXXX${startTime === "" ? ", XX:XX น.":`, ${startTime} น.`}`:`${startDate}${startTime === "" ? ", XX:XX น.":`, ${startTime} น.`}`} ถึง ${expiredDate === "" ? `XX XXXX${expiredTime === "" ? ", XX:XX น.":`, ${expiredTime} น.`}`:`${expiredDate}${expiredTime === "" ? ", XX:XX น.":`, ${expiredTime} น.`}`}`}
              </p>
              <p style={{
                fontSize : '16px'
              }}>รายละเอียด</p>
