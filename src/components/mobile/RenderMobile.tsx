          ...
          >
              ...
              >
                ...
                >
                  {!couponType ? (
                    ...
                    <img src={couponType === 'INJECTION' ? icon.injection : icon.drug} />
                  )}
                </div>
                <div>
                  <p
                  ...
                  >
                    {checkRai(parseInt(raiConditionMin), parseInt(raiConditionMax))}
                  </p>
                  <p
                    style={{
                      margin: '0px',
                  ...
                  >
                    {expiredDate === '' ? 'หมดเขต XX เดือน XXXX' : `หมดเขต ${expiredDate}`}
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                {`${
                  startDate === ''
                    ? `XX XXXX${startTime === '' ? ', XX:XX น.' : `, ${startTime} น.`}`
                    : `${startDate}${startTime === '' ? ', XX:XX น.' : `, ${startTime} น.`}`
                } ถึง ${
                  expiredDate === ''
                    ? `XX XXXX${expiredTime === '' ? ', XX:XX น.' : `, ${expiredTime} น.`}`
                    : `${expiredDate}${expiredTime === '' ? ', XX:XX น.' : `, ${expiredTime} น.`}`
                }`}
              </p>
              <p
                style={{
              ...
              {<p>{parse(descriptionEditor ?? `<p style="font-size : 16px">...</p>`)}</p>}
              <p
                style={{
                  fontSize: '16px',
                }}
              ...
              {<p>{parse(conditionEditor ?? `<p style="font-size : 16px">...</p>`)}</p>}
              <p
                style={{
                  fontSize: '16px',
                }}
