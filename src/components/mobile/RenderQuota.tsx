          ...
          <div className="p-3">
            ...
            >
              <div
                style={{
                  backgroundImage:
                    "linear-gradient(to bottom, #FBF5B9, #EED787)",
              ...
              <div
                style={{
                  backgroundImage:
                    "linear-gradient(to bottom, #F6EAA7, #FFF7EA)",
                  borderWidth: 5,
                  borderColor: "#523A19",
                }}
              >
                <div className="row space-between">
                  ...
                  <div className="col-lg pt-4">
                    <div className="row" style={{ textAlign: "center" }}>
                      <span style={{ color: "#B26003", fontWeight: "600" }}>
                        รางวัลใหญ่
                      </span>
                      <br />
                      <span
              ...
              <div
                style={{
                  backgroundImage:
                    "linear-gradient(to bottom, #B6A15C, #B89650)",
              ...
              >
                ...
                >
                  ...
                  <div className="col-lg-4">
                    ...
                    <br />
                    <span
                      style={{ fontSize: "20px", top: "4px", color: "#FFFA7D" }}
                    >
                      XX
                    </span>
                    <span style={{ fontWeight: "lighter" }}> สิทธิ์</span>
