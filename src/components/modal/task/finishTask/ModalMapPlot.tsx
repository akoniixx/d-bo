...
const ModalMapPlot: React.FC<ModalMapPlotProps> = ({ show, backButton, plotId, title }) => {
  const [data, setData] = useState<FarmerPlotEntity>()
  const [mapPosition, setMapPosition] = useState<{ lat: number; lng: number }>(LAT_LNG_BANGKOK)
