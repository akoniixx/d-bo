            ...
            <div className='col-lg-4'>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '16px' }}>{numberWithCommas(countPlot1)}</div>
                </div>
              </CardContainer>
            </div>
            <div className='col-lg-4'>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '16px' }}>{numberWithCommas(countPlot2)}</div>
                </div>
              </CardContainer>
            </div>
            <div className='col-lg-4'>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '16px' }}>{numberWithCommas(countPlot3)}</div>
                </div>
              </CardContainer>
            </div>
          </div>
