...
const DetailDronerPoint = () => {
  ...
  const renderDetailRecipient = () => {
    ...
    let checkDroner: any = dataMock.description.filter(
            ...
            <CardContainer>
              ...
              <Form style={{ padding: "20px" }}>
                <Row>
                  <Col span={9}>
                    <div>ชื่อเกษตรกร</div>
                    <u style={{ color: "#219653" }}>
                      {checkFarmer[0].farmerName}
                    </u>
                  </Col>
                  <Col span={8}>
                    <div>เบอร์โทร</div>
              ...
              <Form style={{ padding: "20px" }}>
                <Row>
                  <Col span={9}>
                    ...
                    <u style={{ color: "#EA973E" }}>
                      {checkDroner[0].dronerName}
                    </u>
                  </Col>
                  <Col span={8}>
                    <div>เบอร์โทร</div>
          ...
          >
            <div>
              <b
                style={{
                  color:
                    dataMock.type === "การจ้างงาน" ? "#219653" : color.Error,
                }}
              >
          ...
          return {
            children: (
              <span
                style={{
                  color:
                    row.status === "รอรับคะแนน" ? color.Grey : color.Success,
                }}
              >
                <Badge
                  color={
