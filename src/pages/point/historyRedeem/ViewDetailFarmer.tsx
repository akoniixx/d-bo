        ...
        return {
          children: (
            <>
              ...
              >
                <Badge color={row.status === 'ยกเลิก' ? color.Error : color.Success} /> {row.status}
              </span>
            </>
          ),
        }
        ...
        >
          ...
          <Row>
            ...
            <Col span={3}>
              ...
              <div>{DateTimeUtil.formatDateTime(data?.dateAppointment || '')}</div>
            </Col>
            <Col span={3}>
              <div>ชื่อเกษตรกร</div>
            ...
            <Col span={3}>
              ...
              <Row>
                <div>{numberWithCommas(parseFloat(data?.totalPrice || ''))} บาท</div>
                <div className='pt-0'>
                  <InvoiceTask
                    data={dataInvoice}
          ...
          <Row>
            <Col span={4}>
              ...
              <div style={{ color: color.Success }}>
                ...
                {data?.farmer.nickname && <ShowNickName data={data?.farmer.nickname} menu='INFO' />}
              </div>
            </Col>
            <Col span={4}>
              <div>เบอร์โทร</div>
...
export default ViewDetailFarmer
