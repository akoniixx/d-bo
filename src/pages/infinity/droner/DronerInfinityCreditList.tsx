...
const DronerInfinityCreditList: React.FC<any> = () => {
  ...
  const columns = [
            ...
            >
              ...
              <CaretDownOutlined
                style={{
                  ...
                  bottom: 2,
                  color:
                    filter.sortBy === 'updatedAt' && filter.sortDirection === 'DESC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
    ...
    {
      title: () => {
        return <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>ชื่อรายการ</div>
      },
      dataIndex: 'listname',
      key: 'listname',
      render: (value: any, row: any, index: number) => {
    ...
    {
      title: () => {
        return <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>ประเภทการแลก</div>
      },
            ...
            >
              <CaretUpOutlined
                style={{
                  ...
                  top: 2,
                  color:
                    filter.sortBy === 'credit' && filter.sortDirection === 'ASC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
              ...
              <CaretDownOutlined
                style={{
                  ...
                  bottom: 2,
                  color:
                    filter.sortBy === 'credit' && filter.sortDirection === 'DESC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
            ...
            >
              <CaretUpOutlined
                style={{
                  ...
                  top: 2,
                  color:
                    filter.sortBy === 'point' && filter.sortDirection === 'ASC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
              ...
              <CaretDownOutlined
                style={{
                  ...
                  bottom: 2,
                  color:
                    filter.sortBy === 'point' && filter.sortDirection === 'DESC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
    ...
    },
    {
            ...
            >
              <CaretUpOutlined
                style={{
                  ...
                  top: 2,
                  color:
                    filter.sortBy === 'cash' && filter.sortDirection === 'ASC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
              ...
              <CaretDownOutlined
                style={{
                  ...
                  bottom: 2,
                  color:
                    filter.sortBy === 'cash' && filter.sortDirection === 'DESC'
                      ? '#ffca37'
                      : 'white',
                }}
                onClick={() => {
      ...
      render: (value: any, row: any, index: number) => {
        return (
          <span>
            {row.cash == 0 || row.cash == '0' ? '-' : numberWithCommas(row.cash) + ' บาท'}
          </span>
        )
      },
    },
    {
      title: () => {
        return <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>สถานะ</div>
      },
      dataIndex: 'status',
      key: 'status',
      render: (value: any, row: any, index: number) => {
        return (
          <>
            <span style={{ color: STATUS_COLOR_CREDIT[row.status] }}>
              <Badge color={STATUS_COLOR_CREDIT[row.status]} /> {STATUS_CREDIT_MAPPING[row.status]}
            </span>
          </>
        )
      },
        ...
        <div className='col-3'>
          <div className='p-3 rounded' style={{ backgroundColor: '#FFF', width: '98%' }}>
            ...
            >
              ...
              >
                {data.isLoading ? 0 : numberWithCommas(data.data.point)}
              </p>
            </div>
          </div>
        </div>
        <div className='col-3'>
          <div className='p-3 rounded' style={{ backgroundColor: '#FFF', width: '98%' }}>
            ...
            >
              ...
              >
                {data.isLoading ? 0 : numberWithCommas(data.data.pointCredit)}
              </p>
            </div>
          </div>
        </div>
        <div className='col-3'>
          <div className='p-3 rounded' style={{ backgroundColor: '#FFF', width: '98%' }}>
            ...
            >
              ...
              >
                {data.isLoading ? 0 : numberWithCommas(data.data.cashcredit)}
              </p>
            </div>
          </div>
        </div>
        <div className='col-3'>
          <div className='p-3 rounded' style={{ backgroundColor: '#FFF', width: '98%' }}>
            ...
            >
              ...
              >
                {data.isLoading ? 0 : numberWithCommas(data.data.credit)}
              </p>
            </div>
          </div>
        </div>
