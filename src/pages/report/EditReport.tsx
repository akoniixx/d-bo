    ...
    <Form style={{ padding: '32px' }}>
      <div className='row'>
        <div className='col-lg-6'>
          ...
          <Form.Item>
            <span style={{ color: color.Grey }}>{!data.data.comment && '-'}</span>
          </Form.Item>
        </div>
        ...
        <div className='col-lg-5'>
              ...
              <div className='col-lg-6'>
                <span>
                  {data.data.reviewDronerAvg > '0' ? (
                    <Row>
                      {starIcon}
                      <span>{parseFloat(data.data.reviewDronerAvg).toFixed(1)}</span>
                    </Row>
                  ) : (
                    '-'
                  )}
              ...
              <div className='col-lg-6'>
                {data.data.reviewDronerDetail !== null ? (
                  <Row>
                    {starIcon}
                    <span>
                      {parseFloat(data.data.reviewDronerDetail.pilotEtiquette).toFixed(1)}
                    </span>
                  </Row>
                ) : (
                  '-'
            ...
            <div className='row'>
              ...
              <div className='col-lg-6'>
                {data.data.reviewDronerDetail !== null ? (
                  <Row>
                    {starIcon}
                    <span>{parseFloat(data.data.reviewDronerDetail.punctuality).toFixed(1)}</span>
                  </Row>
                ) : (
                  '-'
                )}
              ...
              <div className='col-lg-6'>
                {data.data.reviewDronerDetail !== null ? (
                  <Row>
                    {starIcon}
                    <span>
                      {parseFloat(data.data.reviewDronerDetail.sprayExpertise).toFixed(1)}
                    </span>
                  </Row>
                ) : (
                  '-'
          ...
          {data.data.statusPayment != null && data.data.statusPayment != 'SUCCESS' ? (
            <Form.Item key={data.data.statusPayment}>
              <Radio.Group defaultValue={data.data.statusPayment} onChange={handleChangeStatus}>
      ...
      <div className='container text-center' style={{ padding: '30px' }}>
        ...
        <div className='row'>
          ...
          <div className='col-lg-4 text-start'>
            ...
            <Form.Item>
              <Input disabled defaultValue={data.data.unitPrice} suffix={'บาท/ไร่'} />
            </Form.Item>
          </div>
          <div className='col-lg-4 text-start'>
            <label>จำนวนไร่</label>
            <Form.Item>
              <Input disabled defaultValue={data.data.farmerPlot.raiAmount} suffix='ไร่' />
            </Form.Item>
          </div>
        </div>
        <div className='row'>
            ...
            {data.imageIdCard.path != '' ? (
              <div className='col-lg-6'>
                ...
                >
                  ...
                  <Upload listType='picture' defaultFileList={[...IdCard]} disabled />
                </Form>
              </div>
            ) : (
              <div className='col-lg-6'>
            ...
            {data.imageBookBank.path != '' ? (
              <div className='col-lg-6'>
                ...
                >
                  ...
                  <Upload listType='picture' defaultFileList={[...BookBank]} disabled />
                </Form>
              </div>
            ) : (
              <div className='col-lg-6'>
          ...
          <div className='col-lg-3'>
            ...
            <h5 style={{ color: color.Success }} className='p-2'>
              {data.data.totalPrice !== null
                ? numberWithCommasToFixed(parseFloat(data.data.totalPrice)) + ' บาท'
                : '0 บาท'}
            </h5>
          </div>
          ...
          <div className='col-lg-4'>
            <Form.Item>
              ...
              <Input
                ...
                placeholder='0.0'
                value={
                  data.data.fee !== null ? numberWithCommasToFixed(parseFloat(data.data.fee)) : 0
                }
                suffix='บาท'
              />
            </Form.Item>
