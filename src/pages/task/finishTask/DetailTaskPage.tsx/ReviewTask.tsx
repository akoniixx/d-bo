      ...
      <div className='row'>
        ...
        <div className='col-lg-5'>
          ...
          <Form.Item style={{ color: color.Grey }}>
            ...
            <span>
              {'(จำนวน' + ' ' + data.data.farmAreaAmount + ' ไร่)'} ราคาไร่ละ {data.data.unitPrice}{' '}
              บาท
            </span>
          </Form.Item>
          ...
          <Form.Item>
            ...
            <br />
            <Radio.Group style={{ width: '100%' }} className='pt-3' onChange={onChangeCanReview}>
    ...
    <Form style={{ padding: '32px' }}>
      {data.data.droner !== null && data.data.droner.isDelete !== true ? (
        <div className='row'>
          ...
          <div className='col-lg-3'>
            <span>{data.data.droner !== null ? data.data.droner.telephoneNo : null}</span>
          </div>
          <div className='col-lg-3'>
            <span>
