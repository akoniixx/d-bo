...
import { HistoryEntity, HistoryEntity_INIT } from '../../../../entities/HistoryEntities'
      ...
      <div className='row'>
        <div className='col-lg-6'>
            ...
            <div className='col-lg-6'>
              ...
              <Form.Item>
                <Input
                  ...
                  value={moment(new Date(data.data.dateAppointment)).format(dateFormat)}
                  disabled
            ...
            <div className='col-lg-6'>
              ...
              <Form.Item>
                <Input
                  style={{ width: '100%' }}
                  placeholder='16:00'
                  value={moment(new Date(data.data.dateAppointment)).format(timeFormat)}
                  disabled
          ...
          <Form.Item>
            <Select
              disabled
              value={
                data.data.purposeSpray !== null ? data.data.purposeSpray.purposeSprayName : '-'
              }
            />
          </Form.Item>
        ...
        <div className='col-lg-5'>
          ...
          <Form.Item style={{ color: color.Grey }}>
            ...
            <span>
              {'(จำนวน ' + data.data.farmAreaAmount + ' ไร่)'} ราคาไร่ละ {data.data.unitPrice} บาท
            </span>
          </Form.Item>
          ...
          <Form.Item>
            <span style={{ color: color.Error }}>
              ...
              {history != null ? ' ' + '(' + TASK_HISTORY[history.beforeValue] + ')' : null}
              <br />
            </span>
          </Form.Item>
          <Form.Item>
            <TextArea
              rows={3}
              disabled
              value={data.data.statusRemark != null ? data.data.statusRemark : undefined}
            />
          </Form.Item>
        </div>
      </div>
      ...
      <div className='container text-center' style={{ padding: '30px' }}>
        <div className='row'>
          <div className='col-lg-4 text-start'>
            ...
            <Form.Item>
              <Input
                disabled
                defaultValue={data.data.farmer.firstname + ' ' + data.data.farmer.lastname}
              />
            </Form.Item>
          </div>
          <div className='col-lg-4 text-start'>
        ...
        <div className='row'>
          ...
          <div className='col-lg-4 text-start'>
            ...
            <Form.Item>
              <Input disabled defaultValue={data.data.farmAreaAmount} suffix='ไร่' />
            </Form.Item>
          </div>
        </div>
        <div className='row'>
      ...
      {data.data.droner && data.data.droner.isDelete !== true ? (
        <Form style={{ padding: '32px' }}>
          <div className='row'>
            ...
            <div className='col-lg-1'>{parseFloat(data.data.distance).toFixed(0) || 0} km</div>
            <div className='col-lg'>
                ...
                <Avatar
                  ...
                  src={
                    data.data.droner?.dronerDrone[0] != undefined
                      ? data.data.droner.dronerDrone[0].drone.droneBrand.logoImagePath
                      : null
                  }
              ...
              <br />
              <p style={{ fontSize: '12px', color: color.Grey }}>
                {data.data.droner?.dronerDrone?.length > 1 ? '(มากกว่า 1 ยี่ห้อ)' : null}
              </p>
            </div>
          </div>
        </Form>
            ...
            <div className='row'>
              {item.dronerDetail[0] && JSON.parse(item.dronerDetail[0]) !== null && (
                <>
                    ...
                    <span>
                      ...
                      <p style={{ fontSize: '12px', color: color.Grey }}>
                        ...
                        {JSON.parse(item.dronerDetail[0]).droner_code.nickname && (
                          <ShowNickName
                            data={JSON.parse(item.dronerDetail[0]).droner_code.nickname}
                            menu='INFO'
                          />
                        )}
                      </p>
                  ...
                  <div className='col-lg-2'>
                    <span>{JSON.parse(item.dronerDetail[0]).telephone_no ?? ''}</span>
                  </div>
                  <div className='col-lg-3'>
                    <span>
                  ...
                  <div className='col-lg-1'>
                    {JSON.parse(item.dronerDetail[0]).distance.toFixed(0) || 0} km
                  </div>
                  <div className='col-lg-2'>
                    <span>
                      <Avatar
                        size={25}
                        src={
                          JSON.parse(item.dronerDetail[0]).logo_drone_brand != undefined
                  ...
                  <div className='col-lg-2'>
                    ...
                    >
                      <Badge color={STATUS_EN_NEWTASK_COLOR_MAPPING[item.status]} />{' '}
      ...
      <Form style={{ padding: '20px', backgroundColor: '#2196531A' }}>
        <div className='row'>
          <div className='col-lg-3' style={{ borderRight: 'solid' }}>
            ...
            <h5 style={{ color: color.primary1 }} className='p-2'>
              {data?.data.totalPrice && numberWithCommasToFixed(parseFloat(data?.data.totalPrice))}{' '}
              บาท
            </h5>
          </div>
            ...
            <h5 style={{ color: color.Warning }} className='p-2'>
              {data?.data.price &&
                numberWithCommasToFixed(
                  parseFloat(data?.data.price) + parseFloat(data?.data.revenuePromotion),
                )}{' '}
              บาท
            </h5>
          </div>
        ...
        <div className='row'>
          <div className='col-lg-4'>
            <Form.Item>
              ...
              <Input
                disabled
                value={data.data.price !== null ? numberWithCommas(parseFloat(data.data.price)) : 0}
                suffix='บาท'
              />
            </Form.Item>
          </div>
          <div className='col-lg-4'>
            <Form.Item>
              ...
              <Input
                disabled
                value={data.data.fee !== null ? numberWithCommas(parseFloat(data.data.fee)) : 0}
                suffix='บาท'
              />
            </Form.Item>
          </div>
        ...
        <div className='row pt-3'>
          <div className='form-group col-lg-6 p-2'>
            ...
            <Input suffix='แต้ม' value={data.data.usePoint} disabled autoComplete='off' />
          </div>
          <div className='form-group col-lg-6 p-2'>
