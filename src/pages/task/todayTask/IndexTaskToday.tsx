...
export default function IndexTodayTask() {
  ...
  const onChangeListWaitStart = (list: CheckboxValueType[]) => {
    ...
    setIndeterminateWaitStart(!!list.length && list.length < statusListWaitStart.length)
  ...
  const onChangeListInprogress = (list: CheckboxValueType[]) => {
    ...
    setIndeterminateInprogress(!!list.length && list.length < statusListInprogress.length)
      ...
      items={[
        {
          label: (
            <>
              ...
              >
                <Checkbox style={{ marginLeft: '20px' }} value='waitStart_normal'>
                  ปกติ
                </Checkbox>
                <br />
                <Checkbox style={{ marginLeft: '20px' }} value='waitStart_problem'>
                  งานมีปัญหา
                </Checkbox>
              </Checkbox.Group>
            </>
        ...
        },
        {
          label: (
            <>
              ...
              >
                <Checkbox style={{ marginLeft: '20px' }} value='inprogress_normal'>
                  ปกติ
                </Checkbox>
                <br />
                ...
                <br />
                <Checkbox style={{ marginLeft: '20px' }} value='inprogress_problem'>
                  งานมีปัญหา
                </Checkbox>
              </Checkbox.Group>
            </>
            ...
            <>
              ...
              >
                ...
                <span style={{ color: color.Error }}>
                  {row.task_is_problem == true ? ' ' + '(' + 'งานมีปัญหา' + ')' : null}
                </span>
                ...
                <span style={{ color: '#56CCF2' }}>
                  {row.task_status_delay == 'EXTENDED' || row.task_status_delay == 'APPROVED'
                    ? ' ' + '(' + 'อนุมัติขยายเวลา' + ')'
                    : null}
                </span>
                {extend == 'APPROVED' ? (
  ...
  return (
    <>
      <span className='container' style={{ fontSize: 22, fontWeight: 'bold', padding: '8px' }}>
        <strong>งานในวันนี้</strong> {'(' + moment(new Date()).format(dateFormat) + ')'}
      </span>
      <div className='d-flex justify-content-between' style={{ marginTop: '20px' }}>
        ...
        >
          ...
          <div className='d-flex justify-content-between'>
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                <strong>ปกติ</strong>
                <strong>{data?.summary != undefined ? data?.summary.waitstartnormal : null}</strong>
              </div>
            </CardContainer>
            <CardContainer
              style={{
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                ...
                <strong>
                  {data?.summary != undefined ? data?.summary.waitstartproblem : null}
                </strong>
              </div>
            </CardContainer>
          </div>
          ...
          <div className='d-flex justify-content-between'>
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                <strong>ปกติ</strong>
                <strong>
                  {data?.summary != undefined ? data?.summary.inprogressnormal : null}
                </strong>
              </div>
            </CardContainer>
            <CardContainer
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                ...
                <strong>
                  {data?.summary != undefined ? data?.summary.waitapprovedelay : null}
                </strong>
              </div>
            </CardContainer>
            <CardContainer
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                ...
                <strong>{data?.summary != undefined ? data?.summary.extended : null}</strong>
              </div>
            </CardContainer>
            <CardContainer
              style={{
            ...
            >
              <div className='d-flex justify-content-between' style={{ color: color.White }}>
                <strong>งานมีปัญหา</strong>
                <strong>
                  {data?.summary != undefined ? data?.summary.inprogressproblem : null}
                </strong>
              </div>
            </CardContainer>
          </div>
