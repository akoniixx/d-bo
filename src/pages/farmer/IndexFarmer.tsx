          ...
          children: (
            <>
              ...
              <span style={{ color: color.Grey }}>
                <UserOutlined style={{ padding: '4px 4px 0 0', verticalAlign: 1 }} />
    ...
    },
    {
      ...
      render: (value: any, row: any, index: number) => {
        return {
          children: (
            <>
              <span>{row.totalRaiCount ? numberWithCommas(row.totalRaiCount) : 0} ไร่</span>
              <span> ({row.totalPlotCount ? numberWithCommas(row.totalPlotCount) : 0} แปลง)</span>
            </>
          ),
        }
      },
          ...
          children: (
            <>
              ...
              {row.applicationType === 'FARMER' && (
                <>
                  <Image src={icon.farmerApp} preview={false} style={{ width: 24, height: 24 }} />
                  <span> {row.firstname + ' ' + row.lastname}</span>
                </>
              )}
            </>
                  ...
                  <Popover
                    ...
                    content={
                      <>
                        <div>
                          <Image
                            src={checkProfile === true ? icon.check : icon.cancel}
                            preview={false}
                        ...
                        <div>
                          <Image
                            src={row.totalPlotCount != 0 ? icon.check : icon.cancel}
                            preview={false}
                            style={{ width: 20, height: 20 }}
                          />
                          <span> แปลงเกษตร</span>
