...
export class RewardDatasource {
  static addReward(data: RewardEntities) {
    ...
    data.startExchangeDate && formData.append('startExchangeDate', data.startExchangeDate)
    data.expiredExchangeDate && formData.append('expiredExchangeDate', data.expiredExchangeDate)
